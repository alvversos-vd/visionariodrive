...
export default function ShiftLiveMap({ shift, className }: Props) {
  ...
  return (
    <div className="relative">
      ...
      />
      <div className="absolute top-2 left-2 z-30 bg-background/85 backdrop-blur-sm rounded-lg px-2.5 py-1.5 text-micro font-mono leading-tight border border-border shadow-sm pointer-events-none">
